  ...
  private void initVariables(View view) {
    ...
    if (activity != null) {
      ...
      if (currentLanguage.equals(LocaleManager.LANGUAGE_ENGLISH)) {
        ...
        binding.chineseButton.setIcon(drawable);
      }
    }
    ...
    binding.englishButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        if (currentLanguage.equals(LocaleManager.LANGUAGE_CHINESE)) {
          MyApplication.localeManager.setNewLocale(activity, LocaleManager.LANGUAGE_ENGLISH);
          restartActivity();
        }
      }
    });
    binding.chineseButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        if (currentLanguage.equals(LocaleManager.LANGUAGE_ENGLISH)) {
          MyApplication.localeManager.setNewLocale(activity, LocaleManager.LANGUAGE_CHINESE);
          restartActivity();
        }
      }
    });
